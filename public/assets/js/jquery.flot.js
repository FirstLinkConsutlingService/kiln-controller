...
(function($){
    ...
    $.color.make=function(r,g,b,a){
        ...
        o.scale=function(c,f){for(var i=0;i<c.length;++i)o[c.charAt(i)]*=f;
            return o.normalize()};
            o.toString=function(){
                if(o.a>=1){
            ...
            o.normalize=function(){
                function clamp(min,value,max){
                    ...
                    o.g=clamp(0,parseInt(o.g),255);o.b=clamp(0,parseInt(o.b),255);
            ...
            $.color.extract=function(elem,css){var c;do{c=elem.css(css).toLowerCase();
                if(c!=""&&c!="transparent")break;
                elem=elem.parent()}while(elem.length&&!$.nodeName(elem.get(0),"body"));
                if(c=="rgba(0, 0, 0, 0)")c="transparent";
                return $.color.parse(c)};
                $.color.parse=function(str){var res,m=$.color.make;
                    ...
                    else{res=lookupColors[name]||[0,0,0];
